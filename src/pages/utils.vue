<template>
    <div class="utils-card border-radius">
        <div class="link box-shadow border-radius">
            ...
            <div class="operate">
                <div v-for="(calculatorItem, calculatorIndex) in calculatorOperate" :key="calculatorIndex" class="row">
                    <div v-for="(item, index) in calculatorItem" :key="calculatorIndex + '-' + index" class="item">
                        <div @click="clickCalculator(item.text)" :class="['item-text', item.type === 'operator' ? 'item-operator' : '']">{{item.text}}</div>
                    </div>
                </div>
            </div>
        </div>
